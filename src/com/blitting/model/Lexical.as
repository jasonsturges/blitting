//
//  com.blitting.model.Lexical
//
//  Predominately work of Ryan Matsikas,
//  visit www.gskinner.com for documentation.
//
//  Extended by Jason Sturges
//
package com.blitting.model
{
	...
	public class Lexical
	{
		...
		public static function alphanumeric(source:String):String
		{
			var pattern:RegExp = /[^A-Z^a-z^0-9]/g;
		...
		public static function compare(x:String, y:String):int
		{
			if (x == null && y == null)
				return 0;
			if (x == null)
